...
ip ssh version 2
!
event manager applet GENERATE-SSH-KEYS
 event timer countdown time 60
 action 1.0 cli command "enable"
 action 2.0 cli command "crypto key generate rsa modulus 2048"
 action 3.0 cli command "no event manager applet GENERATE-SSH-KEYS"
 action 4.0 syslog msg "SSH RSA keys generated by EEM"
!
end
EOF
)"
